...
*/
public class InsertDoubleDataPointQuery extends genorm.runtime.SQLQuery
	{
	private static final Logger s_logger = LoggerFactory.getLogger(InsertDoubleDataPointQuery.class.getName());
	
	public static final String QUERY_NAME = "insert_double_data_point";
	public static final String QUERY = "MERGE INTO data_point (\"metric_id\", \"timestamp\", \"double_value\") VALUES(?, ?, ?)";
	...
	//Deprecated
	public InsertDoubleDataPointQuery()
		{
		super();
		}		
	//---------------------------------------------------------------------------
	public InsertDoubleDataPointQuery(String metricId, java.sql.Timestamp timestamp, double value)
		{
		super();
		m_metricId = metricId;
	...
	//---------------------------------------------------------------------------
	//Deprecated
	public int runUpdate(String metricId, java.sql.Timestamp timestamp, double value)
		{
		int ret = 0;
		...
		try
			...
			genorm_statement.setDouble(3, value);
	...
	public int runUpdate()
		...
		try
			...
			genorm_statement.setDouble(3, m_value);
