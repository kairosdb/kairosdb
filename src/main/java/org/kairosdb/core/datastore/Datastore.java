...
public interface Datastore
{
    ...
    public void putDataPoints(String metricName, ImmutableSortedMap<String, String> tags, List<org.kairosdb.core.DataPoint> dataPoints) throws DatastoreException;
