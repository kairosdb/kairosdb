...
public class CountDataPointsForMetricQuery extends org.agileclick.genorm.runtime.SQLQuery
{
	...
	public String toString()
	{
		...
		sb.append(" metricId=").append(m_metricId);
		sb.append(" startTime=").append(m_startTime);
		sb.append(" endTime=").append(m_endTime);
			...
			implements ResultSet
	{
		...
		*/
		...
		{
			ArrayList<CountDataPointsForMetricData> results = new ArrayList<>();
			int count = 0;
		...
		*/
		...
		{
			CountDataPointsForMetricData ret;
			try
			{
