...
/**
	Returns the metric ids for a specified query.  In essence this
				the initial rows returned.  Takes a tags filter
*/
public class MetricIdsWithTagsQuery extends org.agileclick.genorm.runtime.SQLQuery
{
	...
	public String toString()
	{
		...
		sb.append(" metricName=").append(m_metricName);
		sb.append(" tagCount=").append(m_tagCount);
	...
	{
		List<MetricIdsWithTagsData> getArrayList(int maxRows);
			...
			implements ResultSet
	{
		...
		*/
		...
		{
			ArrayList<MetricIdsWithTagsData> results = new ArrayList<>();
			int count = 0;
