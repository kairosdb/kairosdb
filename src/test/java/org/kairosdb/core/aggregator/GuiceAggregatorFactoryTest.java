...
public class GuiceAggregatorFactoryTest
{
            ...
            throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, ClassNotFoundException
    {
        ...
        ImmutableList<AggregatorMetadata> aggregatorMetadata = factory.getAggregatorMetadata();

        assertThat(1, equalTo(aggregatorMetadata.size()));
        AggregatorMetadata metadata = aggregatorMetadata.get(0);
        ...
        ImmutableList<AggregatorPropertyMetadata> properties = metadata.getProperties();
        ...
        ImmutableList<AggregatorPropertyMetadata> samplingProperties = properties.get(7).getProperties();
    ...
    private static void assertProperty(AggregatorPropertyMetadata property, String name, String label)
    {
    ...
    private static void assertProperty(
            AggregatorPropertyMetadata property,
