...
public class InsertDataPointQuery extends org.agileclick.genorm.runtime.SQLQuery
	...
	public InsertDataPointQuery()
		...
		super();
            try {
                batchStatement = org.kairosdb.datastore.h2.orm.GenOrmDataSource.getConnection().prepareStatement(QUERY);
            }
	...
	public int runUpdate()
        ...
        public void addBatch(String metricsId, Timestamp timestamp, byte[] value) {
            try {
                batchStatement.setString(1, metricsId);
                batchStatement.setTimestamp(2, timestamp);
                batchStatement.setBytes(3, value);
                batchStatement.addBatch();
            } catch (SQLException e) {
                throw new RuntimeException("Datapoint adding failed - batch was not added", e);
            }
        }
        ...
        public void executeBatch() {
            try {
                ...
                throw new RuntimeException("Datapoint adding failed - batch was not executed", e);
            } finally {
                try {
