...
public class MetricIdsQuery extends org.agileclick.genorm.runtime.SQLQuery
{
	...
	{
		List<MetricIdsData> getArrayList(int maxRows);
		List<MetricIdsData> getArrayList();
		MetricIdsData getRecord();
		MetricIdsData getOnlyRecord();
	}
			...
			implements ResultSet
	{
		...
		*/
		...
		{
			ArrayList<MetricIdsData> results = new ArrayList<>();
			int count = 0;
