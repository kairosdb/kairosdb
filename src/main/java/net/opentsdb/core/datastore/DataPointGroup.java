...
public abstract class DataPointGroup implements Iterator<DataPoint>
{
	private String name;
	private TreeMultimap<String, String> tags = TreeMultimap.create();

	public DataPointGroup(String name)
	{
		this.name = name;
	}

	public DataPointGroup(String name, SetMultimap<String, String> tags)
	{
