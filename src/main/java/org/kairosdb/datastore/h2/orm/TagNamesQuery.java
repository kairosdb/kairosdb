...
public class TagNamesQuery extends org.agileclick.genorm.runtime.SQLQuery
{
	...
	{
		List<TagNamesData> getArrayList(int maxRows);
		List<TagNamesData> getArrayList();
		TagNamesData getRecord();
		TagNamesData getOnlyRecord();
	}
			...
			implements ResultSet
	{
		...
		*/
		...
		{
			ArrayList<TagNamesData> results = new ArrayList<>();
			int count = 0;
