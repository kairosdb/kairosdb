...
public class MetricNamesQuery extends org.agileclick.genorm.runtime.SQLQuery
{
	...
	{
		List<MetricNamesData> getArrayList(int maxRows);
		List<MetricNamesData> getArrayList();
		MetricNamesData getRecord();
		MetricNamesData getOnlyRecord();
	}
			...
			implements ResultSet
	{
		...
		*/
		...
		{
			ArrayList<MetricNamesData> results = new ArrayList<>();
			int count = 0;
