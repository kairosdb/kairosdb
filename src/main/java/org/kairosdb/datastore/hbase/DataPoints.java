...
// Copyright (C) 2010-2012  The KairosDB Authors.
//
 ...
 */
public interface DataPoints extends Iterable<HBDataPoint> {
	 ...
	 */
	Map<String, String> getInclusiveTags();
	 ...
	 * <p>
	 * The iterator returned must return each {@link HBDataPoint} in {@code O(1)}.
	 * <b>The {@link HBDataPoint} returned must not be stored</b> and gets
	 ...
	 * and value out of each {@link HBDataPoint} into your own data structures.
	 */
	Iterator<HBDataPoint> iterator();
