...
public class MetricTagValuesQuery extends org.agileclick.genorm.runtime.SQLQuery
{
	...
	public String toString()
	{
		...
		sb.append(" tagName=").append(m_tagName);
	...
	{
		List<MetricTagValuesData> getArrayList(int maxRows);
		List<MetricTagValuesData> getArrayList();
		MetricTagValuesData getRecord();
		MetricTagValuesData getOnlyRecord();
	}
			...
			implements ResultSet
	{
		...
		*/
		...
		{
			ArrayList<MetricTagValuesData> results = new ArrayList<>();
			int count = 0;
