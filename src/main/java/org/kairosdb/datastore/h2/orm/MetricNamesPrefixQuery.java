...
public class MetricNamesPrefixQuery extends org.agileclick.genorm.runtime.SQLQuery
{
	...
	public String toString()
	{
		...
		sb.append(" prefix=").append(m_prefix);
	...
	{
		List<MetricNamesPrefixData> getArrayList(int maxRows);
		List<MetricNamesPrefixData> getArrayList();
		MetricNamesPrefixData getRecord();
		MetricNamesPrefixData getOnlyRecord();
	}
			...
			implements ResultSet
	{
		...
		*/
		...
		{
			ArrayList<MetricNamesPrefixData> results = new ArrayList<>();
			int count = 0;
